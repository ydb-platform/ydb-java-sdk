...
public class TopicRetryableStreamTest {
    ...
    private static class TestStream extends TopicRetryableStream<Empty, Empty, TopicStreamBase<Empty, Empty>> {
        ...
        CompletableFuture<TopicStreamBase<Empty, Empty>> pendingCreation = null;
        ...
        @Override
        protected CompletableFuture<TopicStreamBase<Empty, Empty>> createNewStream(String debugId) {
            if (pendingCreation != null) {
                CompletableFuture<TopicStreamBase<Empty, Empty>> future = pendingCreation;
    ...
    public void asyncStreamCreationTest() {
        ...
        CompletableFuture<TopicStreamBase<Empty, Empty>> creation = new CompletableFuture<>();

...
public final class PersQueueServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<tech.ydb.persqueue.Persqueue.WriteRequest,
      tech.ydb.persqueue.Persqueue.WriteResponse> METHOD_WRITE_SESSION =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "NPersQueue.PersQueueService", "WriteSession"),
          io.grpc.protobuf.ProtoUtils.marshaller(tech.ydb.persqueue.Persqueue.WriteRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(tech.ydb.persqueue.Persqueue.WriteResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<tech.ydb.persqueue.Persqueue.ReadRequest,
      tech.ydb.persqueue.Persqueue.ReadResponse> METHOD_READ_SESSION =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "NPersQueue.PersQueueService", "ReadSession"),
          io.grpc.protobuf.ProtoUtils.marshaller(tech.ydb.persqueue.Persqueue.ReadRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(tech.ydb.persqueue.Persqueue.ReadResponse.getDefaultInstance()));

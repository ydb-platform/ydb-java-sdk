...
public final class S3InternalServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest,
      ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse> METHOD_S3LISTING =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.S3Internal.V1.S3InternalService", "S3Listing"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse.getDefaultInstance()));
  ...
  public static abstract class S3InternalServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void s3Listing(ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest,
                ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse>(
  ...
  public static final class S3InternalServiceBlockingStub extends io.grpc.stub.AbstractStub<S3InternalServiceBlockingStub> {
    ...
    /**
     */
    public ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse s3Listing(ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest request) {
  ...
  public static final class S3InternalServiceFutureStub extends io.grpc.stub.AbstractStub<S3InternalServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse> s3Listing(
        ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_S3LISTING:
          serviceImpl.s3Listing((ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.s3_internal.S3InternalProtos.S3ListingResponse>) responseObserver);
          break;
        default:
  ...
  private static final class S3InternalServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.yandex.ydb.s3_internal.v1.YdbS3InternalV1.getDescriptor();
    }
  }

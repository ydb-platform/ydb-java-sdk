...
public final class OperationServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.OperationProtos.GetOperationRequest,
      ru.yandex.ydb.OperationProtos.GetOperationResponse> METHOD_GET_OPERATION =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.Operation.V1.OperationService", "GetOperation"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.OperationProtos.GetOperationRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.OperationProtos.GetOperationResponse.getDefaultInstance()));
  ...
  public static abstract class OperationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getOperation(ru.yandex.ydb.OperationProtos.GetOperationRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.OperationProtos.GetOperationResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.OperationProtos.GetOperationRequest,
                ru.yandex.ydb.OperationProtos.GetOperationResponse>(
  ...
  public static final class OperationServiceBlockingStub extends io.grpc.stub.AbstractStub<OperationServiceBlockingStub> {
     ...
     * </pre>
     */
    public ru.yandex.ydb.OperationProtos.GetOperationResponse getOperation(ru.yandex.ydb.OperationProtos.GetOperationRequest request) {
  ...
  public static final class OperationServiceFutureStub extends io.grpc.stub.AbstractStub<OperationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.OperationProtos.GetOperationResponse> getOperation(
        ru.yandex.ydb.OperationProtos.GetOperationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_OPERATION:
          serviceImpl.getOperation((ru.yandex.ydb.OperationProtos.GetOperationRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.OperationProtos.GetOperationResponse>) responseObserver);
          break;
        default:
  ...
  private static final class OperationServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.yandex.ydb.operation.v1.YdbOperationV1.getDescriptor();
    }
  }

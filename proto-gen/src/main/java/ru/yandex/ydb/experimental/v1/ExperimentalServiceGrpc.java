...
public final class ExperimentalServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest,
      ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse> METHOD_UPLOAD_ROWS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.Experimental.V1.ExperimentalService", "UploadRows"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest,
      ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse> METHOD_READ_COLUMNS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.Experimental.V1.ExperimentalService", "ReadColumns"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.experimental.ExperimentalProtos.GetShardLocationsRequest,
      ru.yandex.ydb.experimental.ExperimentalProtos.GetShardLocationsResponse> METHOD_GET_SHARD_LOCATIONS =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
  ...
  public static abstract class ExperimentalServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void uploadRows(ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_UPLOAD_ROWS, responseObserver);
    }

    /**
     */
    public void readColumns(ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_READ_COLUMNS, responseObserver);
    }

    /**
     */
    public void getShardLocations(ru.yandex.ydb.experimental.ExperimentalProtos.GetShardLocationsRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest,
                ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse>(
                  this, METHODID_UPLOAD_ROWS)))
          .addMethod(
            METHOD_READ_COLUMNS,
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest,
                ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse>(
  ...
  public static final class ExperimentalServiceBlockingStub extends io.grpc.stub.AbstractStub<ExperimentalServiceBlockingStub> {
     ...
     * </pre>
     */
    public ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse uploadRows(ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest request) {
    ...
    /**
     */
    public ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse readColumns(ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest request) {
      return blockingUnaryCall(
  ...
  public static final class ExperimentalServiceFutureStub extends io.grpc.stub.AbstractStub<ExperimentalServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse> uploadRows(
        ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse> readColumns(
        ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.experimental.ExperimentalProtos.GetShardLocationsResponse> getShardLocations(
        ru.yandex.ydb.experimental.ExperimentalProtos.GetShardLocationsRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPLOAD_ROWS:
          serviceImpl.uploadRows((ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.experimental.ExperimentalProtos.UploadRowsResponse>) responseObserver);
          break;
        case METHODID_READ_COLUMNS:
          serviceImpl.readColumns((ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.experimental.ExperimentalProtos.ReadColumnsResponse>) responseObserver);
          break;
  ...
  private static final class ExperimentalServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.yandex.ydb.experimental.v1.YdbExperimentalV1.getDescriptor();
    }
  }

...
public final class YqlInternalServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest,
      ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> METHOD_EXEC_DATA_QUERY_AST =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.YqlInternal.V0.YqlInternalService", "ExecDataQueryAst"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest,
      ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> METHOD_EXPLAIN_DATA_QUERY_AST =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "Ydb.YqlInternal.V0.YqlInternalService", "ExplainDataQueryAst"),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse.getDefaultInstance()));
  ...
  public static abstract class YqlInternalServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void execDataQueryAst(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_EXEC_DATA_QUERY_AST, responseObserver);
    }

    /**
     */
    public void explainDataQueryAst(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request,
        io.grpc.stub.StreamObserver<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest,
                ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse>(
                  this, METHODID_EXEC_DATA_QUERY_AST)))
          .addMethod(
            METHOD_EXPLAIN_DATA_QUERY_AST,
            asyncUnaryCall(
              new MethodHandlers<
                ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest,
                ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse>(
  ...
  public static final class YqlInternalServiceBlockingStub extends io.grpc.stub.AbstractStub<YqlInternalServiceBlockingStub> {
    ...
    /**
     */
    public ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse execDataQueryAst(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request) {
    ...
    /**
     */
    public ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse explainDataQueryAst(ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request) {
      return blockingUnaryCall(
  ...
  public static final class YqlInternalServiceFutureStub extends io.grpc.stub.AbstractStub<YqlInternalServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse> execDataQueryAst(
        ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse> explainDataQueryAst(
        ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXEC_DATA_QUERY_AST:
          serviceImpl.execDataQueryAst((ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExecDataQueryAstResponse>) responseObserver);
          break;
        case METHODID_EXPLAIN_DATA_QUERY_AST:
          serviceImpl.explainDataQueryAst((ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstRequest) request,
              (io.grpc.stub.StreamObserver<ru.yandex.ydb.yql_internal.YqlInternalProtos.ExplainDataQueryAstResponse>) responseObserver);
          break;
        default:
  ...
  private static final class YqlInternalServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.yandex.ydb.yql_internal.v1.YdbYqlInternal.getDescriptor();
    }
  }

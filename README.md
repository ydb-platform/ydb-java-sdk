...
[![CI](https://img.shields.io/github/actions/workflow/status/ydb-platform/ydb-java-sdk/ci.yaml?branch=develop)](https://github.com/ydb-platform/ydb-java-sdk/actions/workflows/ci.yaml)

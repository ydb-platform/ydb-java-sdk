...
class TxControl {
    ...
    private static final YdbQuery.TransactionSettings TS_READ_COMMITTED_RW = YdbQuery.TransactionSettings.newBuilder()
            .setReadCommittedReadWrite(YdbQuery.ReadCommittedRWModeSettings.getDefaultInstance())
            .build();

...
public class GroupMembership implements Closeable {
    ...
    private void enqueueAcquire() {
        // TODO: enqueue acquire task and retry it with retry policy
        acquireTask = session.acquireSemaphore(groupName, 1, Duration.ofSeconds(30));
    }
